...
import { login, register, studentLogin, sendOtp, verifyOtpCode, sendLoginOtp, verifyLoginOtp, firebaseLogin, me, candidateDashboard, forgotPassword, resetPassword } from '../controllers/authController.js';
import { authenticate, authorize } from '../middleware/auth.js';
import { validate } from '../middleware/validate.js';
import { authLimiter } from '../middleware/rateLimiter.js';
import { loginSchema, registerSchema, forgotPasswordSchema, resetPasswordSchema, otpSendSchema, otpVerifySchema, otpSendLoginSchema, otpVerifyLoginSchema, firebaseLoginSchema } from '../validators/schemas.js';
