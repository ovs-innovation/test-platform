        ...
        <EmptyState
          ...
          action={
            <div className="flex flex-wrap items-center justify-center gap-3">
              <Link
                to="/my-tests"
                className="rounded-full bg-slate-800 px-5 py-2.5 text-xs font-bold text-slate-200 hover:bg-slate-700 transition"
              >
                ← Back to My Test Series
              </Link>
              <Link
                to="/test-series"
                className="rounded-full bg-gradient-to-r from-[#2563eb] to-[#1d4ed8] px-6 py-2.5 text-xs font-extrabold text-white shadow-lg shadow-blue-500/25 transition hover:scale-105"
              >
                Browse Catalog →
              </Link>
            </div>
