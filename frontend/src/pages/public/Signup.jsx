...
export default function Signup() {
  ...
  const [signupMode, setSignupMode] = useState('otp'); // 'otp' or 'password'
  ...
  // Password-based instant registration
  ...
  return (
    <AuthShell title="Create Student Account" subtitle="Register to access online test series, rank analytics, and step solutions.">
      {/* Mode Switcher */}
        ...
        <div>
          {!otpSent ? (
            <form onSubmit={onSendOtp} className="space-y-4">
              ...
              <div>
                <label className="block text-xs font-semibold uppercase tracking-wider text-slate-300 mb-2">
                  Create Password <span className="text-slate-500 font-normal lowercase">(optional)</span>
                </label>
                <input
                  className="w-full rounded-xl border border-[#2A354A] bg-[#070c18] px-4 py-3 text-sm text-slate-100 placeholder:text-slate-500 transition-all duration-200 focus:border-[#0D6EFD] focus:bg-[#0a1224] focus:outline-none focus:ring-2 focus:ring-[#0D6EFD]/35"
                  type="password"
