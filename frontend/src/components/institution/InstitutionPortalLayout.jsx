...
export const INSTITUTION_NAV_ITEMS = [
  ...
  { id: 'test-series', label: 'Assign Test Series', icon: FileText, path: '/institution/test-series' },
  { id: 'ebooks', label: 'Assigned eBooks', icon: BookOpen, path: '/institution/ebooks' },
