        ...
        <div className="relative z-10 flex flex-col sm:flex-row items-center gap-6">
          ...
          <div className="flex-1 text-center sm:text-left">
            ...
            <p className="text-xs text-slate-400 mt-1 max-w-md">
              Powered by Gemini AI — analyses your real test data to generate an 8-section personalised mentor report covering mistakes, weak chapters, revision plan, and score projections.
            </p>
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center gap-2 text-[10px] text-slate-500 px-1">
        ...
        Generated by Gemini AI on {new Date(report.generated_at || Date.now()).toLocaleString('en-IN')} · Based on {report.test_info?.test_name || 'this test'}
      </div>
    </div>
  );
}
