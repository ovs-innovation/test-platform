...
const POINTS = [
  'NTA-style exam screen with timer and palette',
  ...
  return (
    <div className="flex min-h-screen">
      <div className="relative hidden w-[44%] flex-col justify-between overflow-hidden bg-[#f0f6ff] p-10 lg:flex xl:p-12 dark:bg-slate-900">
        <Link to="/" className="relative text-lg font-bold text-slate-900 dark:text-white">AssessPro</Link>
        ...
        <p className="relative text-xs text-slate-400">© {new Date().getFullYear()} AssessPro</p>
      </div>

      <div className="flex flex-1 flex-col justify-center bg-white px-6 py-12 dark:bg-slate-950 sm:px-10">
        <div className="mx-auto w-full max-w-md">
          <div className="mb-6 lg:hidden">
            <Link to="/" className="text-lg font-bold text-slate-900 dark:text-white">AssessPro</Link>
          </div>
