...
const EXAM_TRACKS = [
  {
    ...
    borderStyle: 'border-[#0D6EFD]/40 bg-[#0c1427]/85 backdrop-blur-xl shadow-[0_8px_25px_rgba(13,110,253,0.18)] hover:-translate-y-1 hover:border-[#0D6EFD] hover:shadow-[0_14px_35px_rgba(13,110,253,0.35)]',
    tagBg: 'bg-blue-500/20 text-[#38bdf8] border border-blue-400/40',
  },
  {
    label: 'NEET UG',
    ...
    borderStyle: 'border-[#00F0FF]/40 bg-[#0c1427]/85 backdrop-blur-xl shadow-[0_8px_25px_rgba(0,240,255,0.18)] hover:-translate-y-1 hover:border-[#00F0FF] hover:shadow-[0_14px_35px_rgba(0,240,255,0.35)]',
    tagBg: 'bg-cyan-500/20 text-[#00F0FF] border border-cyan-400/40',
  },
  {
    label: 'NEET PG',
    ...
    borderStyle: 'border-[#7C3AED]/40 bg-[#0c1427]/85 backdrop-blur-xl shadow-[0_8px_25px_rgba(124,58,237,0.18)] hover:-translate-y-1 hover:border-[#7C3AED] hover:shadow-[0_14px_35px_rgba(124,58,237,0.35)]',
    tagBg: 'bg-purple-500/20 text-[#c084fc] border border-purple-400/40',
  },
  {
    label: 'Foundation',
    ...
    borderStyle: 'border-indigo-500/40 bg-[#0c1427]/85 backdrop-blur-xl shadow-[0_8px_25px_rgba(99,102,241,0.18)] hover:-translate-y-1 hover:border-indigo-400 hover:shadow-[0_14px_35px_rgba(99,102,241,0.35)]',
    tagBg: 'bg-indigo-500/20 text-[#818cf8] border border-indigo-400/40',
  },
];
